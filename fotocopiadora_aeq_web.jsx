...
const productos = {
  ...
  tunicas: [
    ['Túnica Normal',1100,'/fotocopiadora-aeq/tunica-normal.jpg'],
    ['Túnica Estampada',1250,'/fotocopiadora-aeq/tunica-estampada.jpg']
  ],
  reglas: [
    ['Regla Orgánica Chica',0,'/fotocopiadora-aeq/regla-chica.jpg'],
    ['Regla Orgánica Mediana',0,'/fotocopiadora-aeq/regla-mediana.jpg'],
    ['Regla Orgánica Grande',0,'/fotocopiadora-aeq/regla-grande.jpg'],
    ['Regla Orgánica Flexible',0,'/fotocopiadora-aeq/regla-flexible.jpg']
  ]
};
    ...
    <div className='min-h-screen bg-white p-6 text-zinc-900'>
      <div className='max-w-7xl mx-auto'>
        <header className='text-center py-8'>
          <img src='/fotocopiadora-aeq/logo-aeq.png' className='h-24 mx-auto mb-4' alt='AEQ'/>
...
<div><h3 className='text-xl font-bold text-orange-500 mb-3'>7mo Semestre</h3><div className='space-y-3'>{productos.cuadernetas.slice(25).map((p,i)=><div key={i} className='flex justify-between gap-3 border rounded-xl p-3'><span>{p[0]} - ${p[1]}</span><button onClick={()=>add(p[0],p[1])} className='bg-orange-500 text-white px-4 py-2 rounded-xl'>Agregar</button></div>)}</div></div>
        ...
        <footer className='mt-12 border-t pt-8 text-center text-zinc-600'>
          <h3 className='text-2xl font-bold text-orange-500 mb-4'>📩 Contacto</h3>
